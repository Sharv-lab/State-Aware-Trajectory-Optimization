            function gen_traj_sensor_data_Quad(TRAJECTORY,SAVE_FLAG)


% Assuming - I can make that trajectory, Generate IMU Outputs
% Assuming - No tilt
...
for k=2:length(u)
    x(k,1) = ad*x(k-1,1) + u(k-1);   %Propagating NOise-driven state model forward in time 
end;
